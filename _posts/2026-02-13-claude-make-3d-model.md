...
**Claude 4.6** создал модель [stl](/assets/blog/3d-vent-grille/vent_grille.stl)+[scad](/assets/blog/3d-vent-grille/vent_grille.stl) с помощью **Python** - **trimesh + manifold3d**
