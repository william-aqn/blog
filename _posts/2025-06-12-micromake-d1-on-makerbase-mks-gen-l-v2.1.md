...
В какой то момент вышел из строя БП и потянул за собой основную плату принтера [Makeboard Mini 2.1.2](/assets/blog/micromake_d1/makeboard_mini_2.1.2.webp) которую больше никто не производит.
...
По сути у меня была голая плата [Makerbase MKS Gen L V2.1](https://github.com/makerbase-mks/MKS-GEN_L/wiki/MKS_GEN_L_V2), и просто направляющие с движками, синяя изолента, экструдер с двумя обдувами и стол с подогревом.
